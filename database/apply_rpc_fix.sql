-- ============================================
-- Fix: Update assign_pathway_with_questions RPC Function
-- ============================================
-- Run this in Supabase SQL Editor to fix the column name error
-- ============================================
...
BEGIN
    ...
    -- FIXED: Using actual column names from questions table
