-- Fix the UUID typo and move Card Match to correct Mid level

-- The correct Mid level ID (without the extra '2' at the end)
UPDATE questions
SET level_id = '760edfbb-949b-482f-b06d-1c606659a99a'
...
SELECT 
  ...
  COUNT(*) as question_count
FROM questions q
WHERE q.level_id = '760edfbb-949b-482f-b06d-1c606659a99a';
